...
internal class ClassLinkerWrapper<T> private constructor(
        ...
        private val binders: Array<ItemViewBinder<T, *>>) : Linker<T> {


    override fun index(t: T): Int {
        val userIndexClass = classLinker.index(t)
        ...
        throw IndexOutOfBoundsException(
                String.format("%s is out of your registered binders'(%s) bounds.",
                        userIndexClass.name, Arrays.toString(binders))
        )
    }
    ...
    companion object {
        ...
        fun <T> wrap(
                ...
                binders: Array<ItemViewBinder<T, *>>): ClassLinkerWrapper<T> {
